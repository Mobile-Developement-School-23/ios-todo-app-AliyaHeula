...
// Testing saving to JSON
    let test = FileCache()
    test.createNewItem(id: "hardcode_id", text: "text", importance: .low, deadline: nil, isDone: false)
    test.createNewItem(id: nil, text: "newone", importance: .high, deadline: Date(), isDone: false)
