...
let task1 = TodoItem(id: nil, text: "111 333 444 111 333 444 111 333 444 111 333 444 111 333 444 ", importance: .high, deadline: nil, isDone: true, createdOn: Date(), changedOn: Date())
